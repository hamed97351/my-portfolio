...
<div class="container">
   <h2 class="text-center mt-4">ادخل بيانات الشخص المفقود </h2>

       

        <form action="insert_people_lost.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div style="flex: 1;">
           ...
           <div style="flex: 1;">
            ...
            <div style="flex: 1;">
                ...
                <input type="text" id="location" name="loction_lost"> <!-- تأكد من تطابق الاسم مع الكود PHP -->
            </div>
            ...
            <div>
                <label for="product-image">اضغط لاختيار صورةالمفقود</label>
