...
<main class="container">
    <center>
        <h3>الوثائق الموجودة</h3>
    </center>
    <div class="row">
        <?php
        $result = mysqli_query($con, "SELECT * FROM found_document");
        while ($row = mysqli_fetch_array($result)) {
            ...
            <div class='col-lg-4 col-md-6 col-sm-12 mb-4'>
                <div class='card h-100'>
                    ...
                    <div class='card-body'>
                        <h5 class='card-title'>نوع الوثيقة: ".$row['document_type']."</h5>
                        <p class='card-text'>رقم الوثيقة: ".$row['document_number']."</p>
            ...
            if (isset($_SESSION['is_logged_in'])) {
                echo "
                        <div class='btn-group' role='group' aria-label='Basic example'>
                            <a href='edit_found_document.php?id=".$row['id']."' class='btn btn-primary btn-custom'>تعديل المنشور</a>
