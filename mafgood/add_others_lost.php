...
<head>
    ...
    <title>اضافة مقتنيات اخري</title>
    <style>
             .laa{
...
?>
    ...
    <div class="container">
        ...
        <h3 class="form-title">ادخل بيانات المقتينات</h3>
        <form action="insert_others_lost.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
         ...
         <div class="form-group" style="display: flex; gap: 10px;">
            ...
            <div style="flex: 1;">
                <label for="name"> نوع المقتنى</label>
                <input type="text" id="other_type" name="other_type" required>
            </div>
            <div style="flex: 1;">
            ...
            <div class="form-group" style="display: flex; gap: 10px;">
            <div style="flex: 1;">
                <label for="dob">التاريخ</label>
                <input type="date" id="dob" name="dob">
            </div>
            <div style="flex: 1;">
                <label for="city">مكان الفقد</label>
                <input type="text" id="location" name="loction_lost" required> <!-- تأكد من تطابق الاسم مع الكود PHP -->
            </div>
