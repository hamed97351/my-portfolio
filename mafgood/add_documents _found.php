...
?>
    <div class="container">
             ...
             <h3 class="form-title">ادخل بيانات  الوثائق</h3>
             <form action="insert_documents_found.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div style="flex: 1;">
            ...
            <div style="flex: 1;">
                ...
                <input type="text" id="location" name="loction"> <!-- تأكد من تطابق الاسم مع الكود PHP -->
            </div>


            <div style="flex: 1;">
                <label for="address">اضافة وصف</label>
                <input type="text" id="descriptionription" name="descriptionription" required>
            </div>
            ...
            <div>
                <label for="image">اضغط لاختيار صورة المفقود</label>
