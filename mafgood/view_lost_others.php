...
<head>
    ...
    <title>شاشة عرض المفقودات</title>
...
<main class="container">
    ...
    <div class="row">
        <?php
        $result = mysqli_query($con, "SELECT * FROM lost_others");
            ...
            if (isset($_SESSION['is_logged_in'])) {
                echo "
                        <div class='btn-group' role='group' aria-label='Basic example'>
                            <a href='edit_lost_others.php?id=".$row['id']."' class='btn btn-primary btn-custom'>تعديل المنشور</a>
