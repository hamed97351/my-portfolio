...
?>
    ...
    <main class="container">
        <div class="form-title">ادخل بيانات المقتينات</div>
        <form action="insert_others_found.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
         ...
         <div class="form-group" style="display: flex; gap: 10px;">
            ...
            <div style="flex: 1;">
                ...
                <input type="text" id="location" name="loction" required> <!-- تأكد من تطابق الاسم مع الكود PHP -->
            </div>
