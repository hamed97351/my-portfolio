...
if (isset($_POST['delete'])) {
    ...
    mysqli_query($con, "DELETE FROM found_others WHERE id='$id'");
    header("Location: view_found_others.php"); // Redirect after deletion
...
<head>
    ...
    <title>شاشة عرض الموجودات</title>
...
<main class="container">
    ...
    <div class="row">
        <?php
        $result = mysqli_query($con, "SELECT * FROM found_others");
            ...
            <div class='col-lg-4 col-md-6 col-sm-12 mb-4'>
                <div class='card h-100'>
                    ...
                    <div class='card-body'>
                        ...
                        <p class='card-text'>النوع: ".$row['other_type']."</p>
            ...
            if (isset($_SESSION['is_logged_in'])) {
                echo "
                        <div class='btn-group' role='group' aria-label='Basic example'>
                            <a href='edit_found_others.php?id=".$row['id']."' class='btn btn-primary btn-custom'>تعديل المنشور</a>
