...
if(isset($_POST['upload'])){
    ...
    $IMAGE = $_FILES['image'];
        ...
        $insert = "INSERT INTO lost_others (name , other_type, description, date, location, contact, image) VALUES (   '$NAME', '$OTHER_TYPE', '$DESCRIPTION', '$date', '$location', '$CONTACT', '$image_up')";
