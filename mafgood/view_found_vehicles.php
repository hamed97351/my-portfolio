...
<main class="container">
    ...
    <div class="row">
        <?php
        $result = mysqli_query($con, "SELECT * FROM found_vehicles");
                ...
                <div class='card h-100'>
                    ...
                    <div class='col-md-8'>
                        <div class='card-body'>
                            ...
                            <p class='card-text'>نوع المركبة: ".$row['vehicle_type']."</p>
                            <p class='card-text'>رقم اللوحة: ".$row['plate_number']."</p>
                            <p class='card-text'>الشاسي: ".$row['chassis']."</p>
                            <p class='card-text'>الموديل: ".$row['model']."</p>
                            <p class='card-text'>اللون: ".$row['color']."</p>
            ...
            if (isset($_SESSION['is_logged_in'])) {
                echo "
                            <div class='btn-group' role='group' aria-label='Basic example'>
                                <a href='edit_found_vehicles.php?id=".$row['id']."' class='btn btn-primary btn-custom'>تعديل المنشور</a>
...
<a href="home_page.php" class="back-home">عودة للصفحة الرئيسية</a>
<footer>
