...
<body>
   ...
   <nav class="navbar navbar-expand-lg" style="background-color:#004d40;">
    ...
    <div class="container">
        <div class="content">
            <div class="box">
             <div class="label">إضافة المفقودات</div>
                <div class="sub-box">
                    <a href="add_people_lost.php">
                        <img src="images/website/add_lost_people.png" alt="إضافة اشخاص" class="full-image">
                        
                    </a>

                    <a href="add_vehicles_lost.php">
                        <img src="images/website/add_lost_vehicles.png" alt="إضافة مركبات" class="full-image">
                        
                    </a>
                   
                    <a href="add_documents _lost.php">
                        <img src="images/website/add_lost_id.png" alt="إضافة وثائق" class="full-image">
                        
                    </a>
                    <a href="add_others_lost.php">
                        <img src="images/website/add_lost_others.png" alt="إضافة مقتنيات اخرى" class="full-image">
