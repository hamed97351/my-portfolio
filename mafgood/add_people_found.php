...
<div class="container">
   <h2 class="text-center mt-4">ادخل بيانات الشخص الموجود </h2>

       

        <form action="insert_people_found.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div style="flex: 1;">
            ...
            <div style="flex: 1;">
                <label for="category">الجنس</label>
           ...
           <div style="flex: 1;">
            ...
            <div style="flex: 1;">
                ...
                <input type="text" id="location" name="loction_found"> <!-- تأكد من تطابق الاسم مع الكود PHP -->
            </div>
            ...
            <div>
                <label for="product-image">اضغط لاختيار صورة الموجود</label>
