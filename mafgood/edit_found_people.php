...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($con, "SELECT * FROM found_people WHERE id='$id'");
...
<div class="container">
    <h2 class="text-center mt-4">تحديث بيانات الاشخاص الموجودين  </h2>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <!-- Modified to display two inputs in one line -->
