...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($con, "SELECT * FROM lost_others WHERE id='$id'");
    ...
    header("Location: view_lost_others.php");
    exit;
}
...
if (isset($_POST['delete'])) {
    ...
    mysqli_query($con, "DELETE FROM lost_others WHERE id='$id'");
    header("Location: view_lost_others.php"); // Redirect after deletion
    exit;
}
?>
...
<nav class="navbar navbar-expand-lg" style="background-color:#004d40;">
    ...
    <div class="container">
        <h2 class="text-center mt-4">تعديل المقتنيات المفقودة</h2>
