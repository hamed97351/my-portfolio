...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = mysqli_query($con, "SELECT * FROM found_vehicles WHERE id='$id'");
...
if (isset($_POST['update'])) {
    ...
    $model = $_POST['model'];
    $color = $_POST['color'];
    $location_lost = $_POST['location_found'];
    $date_lost = $_POST['date_found'];
    ...
    $query = "UPDATE found_vehicles SET
              name='$name', 
...
if (isset($_POST['delete'])) {
    ...
    mysqli_query($con, "DELETE FROM found_vehicles WHERE id='$id'");
    header("Location: view_found_vehicles.php"); // Redirect after deletion
    exit;
}
?>
...
<body>
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="location_found">الموقع</label>
                <input type="text" name="location_found" class="form-control" value="<?php echo $row['location_found']; ?>" required>
            </div>
            <div class="form-group">
                <label for="date_found">التاريخ</label>
                <input type="date" name="date_found" class="form-control" value="<?php echo $row['date_found']; ?>" required>
            </div>
